...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/radmin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="/radmin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="/radmin/css/animate.css" rel="stylesheet">
    <link href="/radmin/css/style.css?v=4.1.0" rel="stylesheet">
</head>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">我的商城</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('acc/index')}}">添加分类</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('acc/type')}}">添加类型</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('acc/shu')}}">添加属相</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('acc/shop')}}">添加商品</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('acc/huo')}}">添加货品</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('acc/huo_list')}}">货品展示</a>
                        </li>
                        <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/radmin/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/radmin/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
...
<script src="/radmin/js/jquery.min.js?v=2.1.4"></script>
<script src="/radmin/js/bootstrap.min.js?v=3.3.6"></script>
<script src="/radmin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/radmin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/radmin/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="/radmin/js/hAdmin.js?v=4.1.0"></script>
<script type="text/javascript" src="/radmin/js/index.js"></script>

<!-- 第三方插件 -->
<script src="/radmin/js/plugins/pace/pace.min.js"></script>
